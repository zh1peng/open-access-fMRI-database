...
3, 1000 Functional Connectomes (FCP)
...
5, Philadelphia Neurodevelopmental Cohort
...
7, NeuroInformatics DataBase, NIDBAn open-source database platform for archiving, analysis, and sharing of neuroimaging data. Data from the multi-site projects Autism Brain Imaging Data Exchange (ABIDE), Bipolar–Schizophrenia Network on Intermediate Phenotypes parts one and two (B–SNIP1, B–SNIP2), and Monetary Incentive Delay task (MID) are available for download from the public instance of NiDB, with more projects sharing data as it becomes available.
http://nidb.sourceforge.net/

8, OMEGA: The Open MEG Archive
